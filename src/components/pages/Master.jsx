...
const Master = ({ userGrade = "free" }) => {
  ...
  const canManage = ["admin", "master", "both"].includes(userGrade);
  ...
  const loadVideos = async () => {
    try {
      setLoading(true);
      setError(null);
      const data = await videoService.getMasterVideos();
      setVideos(data);
    } catch (err) {
  ...
  const handleVideoClick = (video) => {
    navigate(`/master/video/${video.Id}`);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8">
          ...
          {canManage && (
            <Button
              ...
              icon="Plus"
              size="lg"
              className="bg-gradient-to-r from-secondary-500 to-purple-600 hover:from-secondary-600 hover:to-purple-700"
            >
              강의 업로드
            </Button>
          )}
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
            <div className="flex items-center">
              <div className="p-3 rounded-lg bg-secondary-100 mr-4">
                <ApperIcon name="Video" className="w-6 h-6 text-secondary-600" />
              </div>
              <div>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">마스터 이상</p>
              </div>
            </div>
          </div>
        ...
        <VideoGrid
          ...
          userGrade={userGrade}
          emptyTitle="등록된 마스터 강의가 없습니다"
          emptyDescription="새로운 마스터 강의를 추가해보세요"
